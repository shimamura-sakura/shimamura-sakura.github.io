...
const world = [
    ...
    new Body3D([
        ...
        [0, 0, 64], [64, 0, 64], [64, 64, 64], [0, 64, 64]], CUBE_INDICES).move([160, 128, 0]),

    new Body3D([
        [0, 0, 0], [64, 0, 0], [64, 64, 0], [0, 64, 0],
        [0, 0, 64], [64, 0, 64], [64, 64, 64], [0, 64, 64]], CUBE_INDICES).move([-256, 128, 0]),

    new Body3D([
        [0, 0, 0], [256, 0, +0], [256, 64, 0], [0, 64, 0],
        [0, 0, 32], [256, 0, 32], [256, 64, 96], [0, 64, 96]], CUBE_INDICES).move([-128, 128, 0]),
    new Body3D([
